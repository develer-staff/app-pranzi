...
ios_catalogs_dir = os.path.join(mydir, 'ios')
android_catalogs_dir = os.path.join(mydir, 'android')
...
app_icon_fn = os.path.join(root_dir, 'imgs', 'app-icon.png')
...
def prepare_folders():
    ...
    if os.path.isdir(ios_catalogs_dir):
        shutil.rmtree(ios_catalogs_dir)
    os.makedirs(ios_catalogs_dir)

    if os.path.isdir(android_catalogs_dir):
        shutil.rmtree(android_catalogs_dir)
    os.makedirs(android_catalogs_dir)
...
if __name__ == '__main__':
    if not os.path.isfile(app_icon_fn):
